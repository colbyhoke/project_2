...
def counties_index():
    return app.send_static_file("counties.html")
...
def api():
    return app.send_static_file("api_routes.html")
...
#
#########
@app.route("/api/v1.0/covid-all", methods=["GET"])
def covid():
...
#
#########
@app.route("/api/v1.0/covid-all/<state_input>", methods=["GET"])
...
#
#########
@app.route("/api/v1.0/masks", methods=["GET"])
def masks():
    # Create the session (link) from Python to the DB
    session = Session(engine)
...
#
#########
@app.route("/api/v1.0/cdc", methods=["GET"])
def cdc():
    # Create the session (link) from Python to the DB
    session = Session(engine)
...
#
#########
@app.route("/api/v1.0/counties", methods=["GET"])
def counties():
    # Create the session (link) from Python to the DB
    session = Session(engine)
...
#
#########
@app.route("/api/v1.0/counties/<state_input>", methods=["GET"])
...
#
#########
@app.route("/api/v1.0/covidtracking-all", methods=["GET"])
...
#
#########
@app.route("/api/v1.0/covidtracking-all/<date_input>", methods=["GET"])
...
#
#########
@app.route("/api/v1.0/covidtracking-current", methods=["GET"])
...
#
#########
@app.route("/api/v1.0/covidtracking-current/<state_input>", methods=["GET"])
